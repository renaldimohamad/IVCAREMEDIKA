...
export default function Hero() {
  ...
  return (
    <Section
      ...
      background="white"
      hasDivider={false}
      className="relative z-30 pb-32 sm:pb-40 lg:pb-52">
        ...
        <div className="w-full relative z-10 flex flex-col lg:flex-row lg:min-h-screen">
          ...
          <div className="w-full lg:w-1/2 flex items-center">
            <div className="w-full container-custom lg:pr-12">
              <FadeIn
                className="flex flex-col justify-center text-center lg:text-left pt-32 pb-10 lg:py-36 max-w-xl mx-auto lg:mx-[-40px]"
                x={-30}
                duration={0.8}>
                {/* Badge Pill */}
                ...
                {/* Headline */}
                <h1 className="text-[2rem] sm:text-4xl md:text-5xl lg:text-[3.5rem] text-left font-bold text-navy-700 leading-[1.15] mb-5 tracking-tight font-heading">
                  {hero.headlineLine1}
                  <br />
                ...
                {/* Description */}
                <p className="text-[13px] sm:text-[14px] lg:text-[15px] text-left text-navy-600/70 mb-8 max-w-sm sm:max-w-md lg:max-w-xl leading-relaxed mx-auto lg:mx-0">
                  {hero.description}
                </p>
                {/* CTA Buttons */}
  ...
  ">
          <div
            className="
      bg-white
      rounded-[1.25rem] sm:rounded-[1.75rem] lg:rounded-[2rem]
      shadow-luxury
      border border-primary-50/60
    ...
    ">
          ...
          bg-primary-50/40 lg:bg-transparent
          p-4 lg:p-0
