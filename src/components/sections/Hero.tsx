...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <GradientBlur position="top-right" color="primary" size="xl" className="-translate-y-1/4 translate-x-1/4 z-[1]" />
      <GradientBlur position="custom" color="cyan" size="lg" className="absolute top-1/4 right-[30%] z-[1]" />
      <GradientBlur position="bottom-left" color="primary" size="lg" className="-translate-x-1/4 z-[1]" />
      <GradientBlur position="custom" color="cyan" size="md" className="absolute top-1/2 left-1/4 z-[1]" />
        ...
        <div className="hero-breakout-mask w-full h-full relative">
          ...
          <div className="flex absolute top-32 left-10 bg-white/70 backdrop-blur-xl rounded-[1.75rem] p-3.5 shadow-luxury border border-white/60 items-center gap-3 animate-float z-20 max-w-[200px]">
            ...
            <div className="flex flex-col leading-tight">
              <span className="font-heading font-extrabold text-[11px] text-navy-700">{hero.floatingBadges.badge1.title}</span>
              <span className="text-[9px] text-primary-500 font-bold">{hero.floatingBadges.badge1.subtitle}</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              <span className="font-heading font-extrabold text-[11px] text-navy-700">{hero.floatingBadges.badge2.title}</span>
              <span className="text-[9px] text-cyan-600 font-bold">{hero.floatingBadges.badge2.subtitle}</span>
            </div>
          </div>
        </div>
      </motion.div>
        ...
        >
          <div className="w-full aspect-[4/3] sm:aspect-[16/9] relative overflow-hidden rounded-[2rem]">
            ...
            <div className="hidden sm:flex absolute top-5 left-5 bg-white/70 backdrop-blur-xl rounded-[1.75rem] p-3 shadow-luxury border border-white/60 items-center gap-3 animate-float z-20 max-w-[190px]">
              ...
              <div className="flex flex-col leading-tight">
                <span className="font-heading font-extrabold text-[10px] text-navy-700">{hero.floatingBadges.badge1.title}</span>
                <span className="text-[9px] text-primary-500 font-bold">{hero.floatingBadges.badge1.subtitle}</span>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex flex-col leading-tight">
                <span className="font-heading font-extrabold text-[10px] text-navy-700">{hero.floatingBadges.badge2.title}</span>
                <span className="text-[9px] text-cyan-600 font-bold">{hero.floatingBadges.badge2.subtitle}</span>
              </div>
            </div>
          </div>
