...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-navy-900 text-white pt-20 pb-10 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-primary-400 via-primary-500 to-primary-600"></div>
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16 border-b border-white/10 text-left">
          ...
          <div className="lg:col-span-4 flex flex-col items-start">
            ...
            <p className="text-[12px] text-white/50 leading-relaxed mb-6 font-medium">
              {footer.description}
            </p>

            {/* Quick trust metrics */}
            <div className="flex items-center gap-4 text-xs font-semibold text-primary-400">
          ...
          <div className="lg:col-span-3 lg:pl-10 flex flex-col items-start">
            ...
            <ul className="space-y-3.5 text-xs font-medium text-white/70">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
          ...
          <div className="lg:col-span-2 flex flex-col items-start">
            ...
            <div className="space-y-4 text-xs font-medium text-white/70">
              <div className="flex flex-col leading-tight">
                <span className="text-[10px] text-white/30 uppercase tracking-wide mb-1">
                  Jam Operasional
                </span>
        ...
        <div className="pt-10 flex flex-col sm:flex-row items-center justify-between gap-6 text-[10px] font-semibold text-white/30">
