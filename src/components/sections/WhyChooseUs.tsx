...
import { Heart, ShieldCheck, TrendingUp, UserCheck, ClipboardCheck, Home, MessageSquare } from "lucide-react";
...
export default function WhyChooseUs() {
  ...
  const valueIconsMap = [Heart, ShieldCheck, UserStarIcon, HandshakeIcon, TrendingUp];
  ...
  return (
    <Section id="why-us" background="white" hasDivider={true}>
      ...
      <GradientBlur position="top-left" color="sky" size="md" className="-translate-x-1/2 -translate-y-1/2" />
      <GradientBlur position="bottom-right" color="cyan" size="md" className="translate-x-1/2 translate-y-1/2" />
      ...
      <Container>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-20 lg:mb-24">
          ...
          <FadeIn className="lg:col-span-7 flex flex-col items-start text-left" x={-30}>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-[2.5rem] font-bold text-navy-700 leading-[1.2] mb-6 tracking-tight">
              {aboutSection.headlineLine1}<br />
              <span className="text-primary-500">{aboutSection.headlineLine2}</span>
            </h2>
            <p className="text-sm sm:text-base text-navy-600/70 leading-relaxed mb-6 font-bold">
              {aboutSection.paragraph1}
            </p>
            <p className="text-sm sm:text-base text-navy-600/70 leading-relaxed font-bold">
          ...
          <FadeIn className="lg:col-span-5 relative flex items-center justify-center" x={30}>
            ...
            <GradientBlur position="center" color="primary" size="md" className="scale-75 -z-10" />
          </FadeIn>
        ...
        <div className="mb-20 lg:mb-24">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* VISI CARD */}
            <FadeIn y={20}>
              <Card variant="airy" hoverLift={false} className="p-8 h-full flex flex-col justify-start text-left">
                <div className="flex gap-5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs text-navy-600/70 leading-relaxed font-bold">
              ...
              <Card variant="airy" hoverLift={false} className="p-8 h-full flex flex-col justify-start text-left">
                <div className="flex gap-5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <ul className="space-y-2 text-xs text-navy-600/70 leading-relaxed list-disc pl-4 font-bold">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch mb-16 lg:mb-20">
          ...
          <FadeIn className="lg:col-span-7 flex" x={-20}>
            <Card variant="simple" hoverLift={false} className="p-8 lg:p-10 w-full flex flex-col justify-center bg-primary-50/15 border-primary-100/30 text-left">
              <div className="mb-10">
          ...
          <FadeIn className="lg:col-span-5 flex" x={20} delay={0.15}>
            <Card variant="airy" hoverLift={true} className="p-6 w-full flex flex-col md:flex-row lg:flex-row gap-6 items-center lg:items-start text-left">
              {/* Bag Kit Image */}
              ...
              <div className="flex flex-col justify-between flex-grow h-full">
                <div>
                  ...
                  <p className="text-[12px] text-navy-600/70 leading-relaxed mb-4 font-bold">
