...
export default function Button({
  ...
  const baseClasses = "inline-flex items-center justify-center font-bold tracking-wide transition-all duration-300 rounded-full select-none cursor-pointer focus:outline-none hover:scale-102 active:scale-98";
  ...
  const variantClasses = {
    ...
    outline: "border border-primary-200/50 bg-white/40 text-primary-600 hover:bg-primary-50/50 backdrop-blur-sm",
  ...
  if (href) {
    const isExternal = href.startsWith("http") || href.startsWith("https") || href.startsWith("tel") || href.startsWith("mailto") || href.startsWith("wa.me");
