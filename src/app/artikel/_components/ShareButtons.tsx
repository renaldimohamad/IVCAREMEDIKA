    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex w-full gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-full bg-blue-50 text-blue-400 flex items-center justify-center hover:bg-blue-400 hover:text-white transition-colors shadow-sm"
        ...
        <button
          onClick={handleCopy}
          className="w-10 h-10 rounded-full bg-gray-50 text-gray-600 flex items-center justify-center hover:bg-gray-200 transition-colors shadow-sm relative group cursor-pointer"
