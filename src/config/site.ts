...
export const siteConfig = {
  ...
  whatsapp: {
    ...
    consultationUrl: "https://wa.me/6281354872379?text=Halo%20IVCareMedika,%20saya%20ingin%20berkonsultasi",
  },
  ...
  hero: {
    ...
    description: "IVCare Medika hadir memberikan layanan kesehatan premium dengan pendekatan personal, aman, dan penuh kepedulian untuk Anda dan keluarga.",
  ...
  servicesSection: {
    ...
    subtitle: "Kami menghadirkan standar rumah sakit internasional langsung ke kamar Anda dengan kesterilan mutlak dan kepedulian yang mendalam.",
    list: [
      {
  ...
  aboutSection: {
    ...
    paragraph1: "IVCare Medika hadir untuk memberikan layanan kesehatan profesional di rumah dengan pendekatan personal, aman, dan penuh kepedulian.",
    paragraph2: "Kami percaya bahwa setiap individu berhak mendapatkan perawatan yang berkualitas tanpa harus meninggalkan kenyamanan rumah.",
  ...
  bookingSection: {
    ...
    subtitle: "Dapatkan pelayanan kesehatan berkualitas tinggi hanya dalam empat langkah sederhana tanpa repot mengantre.",
    steps: [
      {
        num: "01",
  ...
  contactSection: {
    ...
    subtitle: "Hubungi layanan admin medis kami yang siaga melayani kebutuhan konsultasi awal Anda secara gratis dan ramah. Kami siap mengirimkan perawat terbaik langsung ke rumah Anda.",
  ...
  faqSection: {
    ...
    subtitle: "Punya pertanyaan mengenai layanan kami? Temukan jawaban lengkap seputar prosedur medis kami di bawah ini.",
    ...
    emptyMessage: "Maaf, tidak menemukan hasil FAQ untuk kata kunci atau filter tersebut."
  },

  // Footer Constants
  footer: {
    description: "IVCare Medika adalah penyedia layanan kesehatan homecare & wellness medis premium bertaraf internasional yang melayani dengan keahlian, kepedulian mendalam, serta kesterilan peralatan mutlak langsung di rumah Anda.",
    copyrightPrefix: "©",
